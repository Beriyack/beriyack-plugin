						...
						<div class="beriyack-card system-status-card">
							...
							<div class="system-status-grid">
								...
								<div class="system-status-item">
									...
									<?php 
									$beriyack_plugin_php_version = PHP_VERSION;
									if ( version_compare( $beriyack_plugin_php_version, '7.4', '>=' ) ) {
										echo '<span class="status-badge success">✅ ' . esc_html( $beriyack_plugin_php_version ) . '</span>';
									} else {
										echo '<span class="status-badge warning">⚠️ ' . esc_html( $beriyack_plugin_php_version ) . ' (Recommandé : 7.4+)</span>';
									}
									?>
								</div>
							...
							<div class="preview-selector-area">
								...
								<select id="beriyack-preview-post-select" class="beriyack-select inline-select">
									...
									<?php if ( ! empty( $recent_posts ) ) : ?>
										<?php foreach ( $recent_posts as $beriyack_plugin_recent_post ) : ?>
											<option value="<?php echo esc_attr( $beriyack_plugin_recent_post->ID ); ?>">
												<?php echo esc_html( get_the_title( $beriyack_plugin_recent_post->ID ) ); ?> (<?php echo esc_html( $beriyack_plugin_recent_post->post_type ); ?>)
											</option>
										<?php endforeach; ?>
									<?php endif; ?>
								</select>
